...
int main(int argc, const char * argv[]) {
    ...
    std::string imgLoc = "/Users/adbonzanini/Box Sync/Berkeley/Research/Cpp-MPC/multiStageMPCdoubleIntegrator/multiStageMPCdoubleIntegrator/";
    std::string imgTitle;
...
//    std::cout << p.Emat.block(0, 0, 5, 5) << std::endl;
